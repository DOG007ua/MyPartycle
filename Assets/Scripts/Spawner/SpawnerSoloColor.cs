...
public class SpawnerSoloColor : ISpawner
{
    private DataSoloColor Data { get; set; }
    private IObjectPool objectPool;
    private float timeNow = 0;
    private Transform parentMovePartycle;
    private float timeSpawn = 0;

    public SpawnerSoloColor(IObjectPool objectPool, IData Data, Transform parentMovePartycle)
    {
        this.Data = Data as DataSoloColor;
